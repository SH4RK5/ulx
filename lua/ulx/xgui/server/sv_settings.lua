...
function settings.init()
	ULib.ucl.registerAccess("xgui_gmsettings", "superadmin",
		"Allows changing of gamemode-specific settings on the settings tab in XGUI.", "XGUI")
	ULib.ucl.registerAccess("xgui_svsettings", "superadmin",
		"Allows changing of server and ULX-specific settings on the settings tab in XGUI.", "XGUI")
	...
	ULib.replicatedWritableCvar("sv_alltalk", "rep_sv_alltalk", GetConVarNumber("sv_alltalk"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("sv_voiceenable", "rep_sv_voiceenable", GetConVarNumber("sv_voiceenable"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("ai_disabled", "rep_ai_disabled", GetConVarNumber("ai_disabled"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("ai_ignoreplayers", "rep_ai_ignoreplayers", GetConVarNumber("ai_ignoreplayers"), false,
		false, "xgui_svsettings")
	ULib.replicatedWritableCvar("ai_serverragdolls", "rep_ai_serverragdolls", GetConVarNumber("ai_serverragdolls"), false,
		false, "xgui_svsettings")
	ULib.replicatedWritableCvar("sv_sticktoground", "rep_sv_sticktoground", GetConVarNumber("sv_sticktoground"), false,
		false, "xgui_svsettings")
	ULib.replicatedWritableCvar("sv_playerpickupallowed", "rep_sv_playerpickupallowed",
		GetConVarNumber("sv_playerpickupallowed"), false, false, "xgui_svsettings")
	ULib.replicatedWritableCvar("mp_falldamage", "rep_mp_falldamage", GetConVarNumber("mp_falldamage"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("gmod_suit", "rep_gmod_suit", GetConVarNumber("gmod_suit"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("sv_gravity", "rep_sv_gravity", GetConVarNumber("sv_gravity"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("sv_friction", "rep_sv_friction", GetConVarNumber("sv_friction"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("phys_timescale", "rep_phys_timescale", GetConVarNumber("phys_timescale"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("sv_defaultdeployspeed", "rep_sv_defaultdeployspeed",
		GetConVarNumber("sv_defaultdeployspeed"), false, false, "xgui_svsettings")
	ULib.replicatedWritableCvar("sv_noclipspeed", "rep_sv_noclipspeed", GetConVarNumber("sv_noclipspeed"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("gmod_maxammo", "rep_gmod_maxammo", GetConVarNumber("gmod_maxammo"), false, false,
		"xgui_svsettings")
	ULib.replicatedWritableCvar("gmod_physiterations", "rep_gmod_physiterations",
		GetConVarNumber("gmod_physiterations"), false, false, "xgui_svsettings")
	ULib.replicatedWritableCvar("sv_timeout", "rep_sv_timeout", GetConVarNumber("sv_timeout"), false, false,
		"xgui_svsettings")
